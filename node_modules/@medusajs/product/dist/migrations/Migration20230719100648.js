...
exports.Migration20230719100648 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20230719100648 extends migrations_1.Migration {
    async up() {
        ...
        this.addSql('create table IF NOT EXISTS "product_collection" ("id" text not null, "title" text not null, "handle" text not null, "metadata" jsonb null, "deleted_at" timestamptz null, constraint "product_collection_pkey" primary key ("id"));');
        ...
        this.addSql('create table IF NOT EXISTS  "image" ("id" text not null, "url" text not null, "metadata" jsonb null, "deleted_at" timestamptz null, constraint "image_pkey" primary key ("id"));');
        ...
        this.addSql('create table IF NOT EXISTS "product_tag" ("id" text not null, "value" text not null, "metadata" jsonb null, "deleted_at" timestamptz null, constraint "product_tag_pkey" primary key ("id"));');
        this.addSql('create index IF NOT EXISTS "IDX_product_tag_deleted_at" on "product_tag" ("deleted_at");');
        this.addSql('create table IF NOT EXISTS "product_type" ("id" text not null, "value" text not null, "metadata" json null, "deleted_at" timestamptz null, constraint "product_type_pkey" primary key ("id"));');
        ...
        this.addSql('create table IF NOT EXISTS "product_option" ("id" text not null, "title" text not null, "product_id" text not null, "metadata" jsonb null, "deleted_at" timestamptz null, constraint "product_option_pkey" primary key ("id"));');
        this.addSql('create index IF NOT EXISTS "IDX_product_option_product_id" on "product_option" ("product_id");');
        ...
        this.addSql('create table IF NOT EXISTS "product_option_value" ("id" text not null, "value" text not null, "option_id" text not null, "variant_id" text not null, "metadata" jsonb null, "deleted_at" timestamptz null, constraint "product_option_value_pkey" primary key ("id"));');
        this.addSql('create index IF NOT EXISTS "IDX_product_option_value_option_id" on "product_option_value" ("option_id");');
        this.addSql('create index IF NOT EXISTS "IDX_product_option_value_variant_id" on "product_option_value" ("variant_id");');
...
exports.Migration20230719100648 = Migration20230719100648;
